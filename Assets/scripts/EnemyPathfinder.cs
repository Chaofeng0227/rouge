...
public class EnemyPathfinder : MonoBehaviour
{
    ...
    void MoveTowardsWanderTarget()
    {
        ...
        rb.velocity = dir.normalized * (GetEffectiveMoveSpeed() * 0.4f);
    }
    ...
    void MoveAlongPathOrDirect()
    {
        if (path == null || path.Count == 0 || currentWaypointIndex >= path.Count)
        {
            ...
            rb.velocity = dirDirect * GetEffectiveMoveSpeed();
            return;
        }
        ...
        if (dist < waypointReachThreshold)
        {
            ...
            if (currentWaypointIndex >= path.Count)
            {
                ...
                rb.velocity = finalDir * GetEffectiveMoveSpeed();
                return;
            }
        ...
        dir.Normalize();
        rb.velocity = dir * GetEffectiveMoveSpeed();
    }
    ...
    float GetEffectiveMoveSpeed()
    {
        ...
        return moveSpeed * statusEffects.MoveSpeedMultiplier;
    }
}
